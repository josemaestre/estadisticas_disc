/*
SQLyog Ultimate
MySQL - 10.3.29-MariaDB : Database - dm_stg
*********************************************************************
*/
...
/*Data for the table `disc_jovenes_processed` */
...
/*Data for the table `disc_personal_processed` */
...
/*Data for the table `disc_processed` */
...
/*Data for the table `evaluado_processed` */
...
/*Data for the table `evaluation_instance` */
...
CREATE TABLE `question_instance` (
  ...
  `first_answer_id` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `question_instance` */
...
/*Table structure for table `valores_cargados` */

DROP TABLE IF EXISTS `valores_cargados`;

CREATE TABLE `valores_cargados` (
  `evaluation_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `valores_cargados` */
